...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="{{route('article.create')}}" class="nav-link text-white">
        ...
        <li>
            <a href="{{route('user.show',auth()->id())}}" class="nav-link text-white">
                <svg class="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlink:href="#people-circle"/></svg>
                My Articles
            </a>
        </li>
        <li>
            <a href="{{route('user.categories',auth()->id())}}" class="nav-link text-white">
                <svg class="bi pe-none me-2" width="16" height="16" aria-hidden="true"><use xlink:href="#people-circle"/></svg>
                My Categories
            </a>
        </li>
